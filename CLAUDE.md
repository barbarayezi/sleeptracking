...
报告格式：数据概览 + 趋势分析 + 身体/心理关联 + 建议。支持深度对话后追加补充章节（如 2026-07-08 报告包含习得性无助、阿斯伯格神经类型、应激循环等深度分析；2026-07-15 报告覆盖 19 条记录，记录了 7/13 耳石症复发 + 120 急救、7/14 就医 + 抗抑郁药物处方、7/15 首次服药等关键事件）。
